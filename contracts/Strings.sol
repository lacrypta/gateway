 ...
 */
function toString(bool value) pure returns (string memory) {
 ...
 * @return  The resulting string
 */
function toString(uint256 value, uint8 decimals) pure returns (string memory) {
    unchecked {
 ...
 * @return  The resulting string
 */
function toString(bytes memory value) pure returns (string memory) {
    unchecked {
 ...
 * @return  The resulting string
 */
function toString(bytes1 value) pure returns (string memory) {
    unchecked {
 ...
 * @return  The resulting string
 */
function toString(bytes2 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes3 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes4 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes5 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes6 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes7 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes8 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes9 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes10 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes11 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes12 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes13 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes14 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes15 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes16 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes17 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes18 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes19 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes20 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes21 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes22 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes23 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes24 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes25 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes26 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes27 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes28 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes29 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes30 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(bytes31 value) pure returns (string memory) {
    unchecked {
        bytes memory temp = new bytes(value.length);
        for (uint8 i = 0; i < value.length; i++) temp[i] = value[i];
        return toString(temp);
 ...
 * @return  The resulting string
 */
function toString(address value) pure returns (string memory) {
    unchecked {
        bytes16 HEX_DIGITS = "0123456789abcdef";
 ...
 */
function toDateTimeParts(Epoch value) pure returns (DateTimeParts memory) {
    return toDateTimeParts(value, Quarters.wrap(0));
}
 ...
 * @return dateTimeParts  The DateTimeParts the given epoch encodes
 */
function toDateTimeParts(Epoch value, Quarters tzOffset) pure returns (DateTimeParts memory) {
    unchecked {
 ...
 * @return  The resulting string
 */
function toIso8601(Epoch value) pure returns (string memory) {
    return toIso8601(value, Quarters.wrap(0));
}
 ...
 * @return  The resulting string
 */
function toIso8601(Epoch value, Quarters tzOffset) pure returns (string memory) {
    unchecked {
        bytes10 DEC_DIGITS = "0123456789";

        DateTimeParts memory parts = toDateTimeParts(value, tzOffset);
